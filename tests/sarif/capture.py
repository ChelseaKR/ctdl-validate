...
CASES: list[tuple[str, str]] = [
    ("bug_class_250", "tests/fixtures/bug_class_250_bare_uuid_for_ctid.json"),
    ("bug_class_252", "tests/fixtures/bug_class_252_wrong_framework_identifier.json"),
]


def run(document: str) -> bytes:
    command = [sys.executable, "-m", "ctdl_validate", document, "--format", "sarif"]
